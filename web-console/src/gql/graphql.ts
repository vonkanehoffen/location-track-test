...
export type All_Location_DataQueryVariables = Exact<{
  limit: Scalars['Int'];
}>;
...
export type Location_SubSubscription = { __typename?: 'subscription_root', journey_location: Array<{ __typename?: 'journey_location', id: number, journey_id: string, location: string, timestamp: any }> };
